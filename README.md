...
- 🌐 Built full-stack projects using **Flask, JavaScript, MySQL/SQLite, HTML/CSS, Bootstrap**
...
A lightweight CRUD task manager with a Flask backend, SQLite database, and responsive Bootstrap UI — deployable via Gunicorn.
...
- 🏅 **SQL (Basic)** — HackerRank ([Verify](https://www.hackerrank.com/certificates/4d7f90ea7121))
